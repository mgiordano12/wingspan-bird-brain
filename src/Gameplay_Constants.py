...
BIRDCARD_FOOD_MAPPING = {'Invertebrate': 'invertebrate', 'Fish': 'fish', 'Rodent': 'rodent', 'Fruit': 'fruit', 'Seed': 'seed', 'Wild': 'wild_food'} # Maps foods in FOOD_TYPES to the field name of BirdCard class
